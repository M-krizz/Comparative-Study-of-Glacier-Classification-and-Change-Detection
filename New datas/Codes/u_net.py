...
# -----------------------------------------------------------
def load_images_and_generate_masks(image_dir, img_size=(128, 128)):
    images, masks = [], []
    for img_name in os.listdir(image_dir):
        ...
        # Generate pseudo mask using Otsu's thresholding
...
# --------------------------------------
# 3. Compile and train the U-Net model
# --------------------------------------
...
# -----------------------------------------------------------
# 5. Predict on a new image and display results
# -----------------------------------------------------------
