...
image_path = 'd:\GLOF\Dataset_Images\Siachen_Glacier_2020.jpg'
...
original = image.copy()
lower_white = np.array([200, 200, 200]) #light colour but not white 
...
cv2.imwrite('d:\GLOF\Dataset_Images\Siachen_Glacier_201411.jpg', output)
