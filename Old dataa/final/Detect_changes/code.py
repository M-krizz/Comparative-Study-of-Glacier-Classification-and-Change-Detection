...
# Sample use case
area_2014, area_2015, area_change = detect_changes(
    "D:\\GLOF\\Code\\Siachen_Glacier_2014.jpg", 
    "D:\\GLOF\\Code\\Siachen_Glacier_2020.jpg", 
    "D:\\GLOF\\final\\Detect_changes\\changes_14_20.jpg"
)


print(f"Glacier Area in 2014: {area_2014} pixels")
print(f"Glacier Area in 2020: {area_2015} pixels")
